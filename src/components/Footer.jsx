...
const Footer = () => {
  return (
    <div className="flex h-[50vh] w-8/12 flex-col items-center justify-center gap-y-32 text-zinc-100">
      <h1 className="NSB text-2xl md:text-5xl font-bold text-[#4648f7]">Connect with me</h1>
      <ul className="flex w-9/12 justify-center">
        <li className="px-4 text-xl md:text-4xl font-bold text-zinc-100">
          {" "}
          <a
            target="_blank"
        ...
        <li className="px-4 text-2xl md:text-5xl font-bold text-zinc-100">
          {" "}
